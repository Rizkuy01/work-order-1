...
<div class="container-fluid px-4">
  <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
    <h4 class="fw-semibold text-primary"><i class="fa-solid fa-wrench me-2"></i> My Work Orders</h4>
    <a href="../actions/add.php" class="btn btn-primary btn-sm shadow-sm">
      <i class="fa-solid fa-plus me-1"></i> Tambah WO
    </a>
  </div>
  ...
  <form method="GET" class="row g-3 mb-3">
    <div class="col-md-4">
      <input type="text" name="search" class="form-control" placeholder="Cari judul atau mesin..." value="<?= safe($_GET['search'] ?? '') ?>">
    </div>
    <div class="col-md-3">
    ...
    <div class="col-md-2">
      <button class="btn btn-outline-primary w-100" type="submit"><i class="fa-solid fa-filter me-1"></i> Filter</button>
    </div>
  </form>
          ...
          <?php if (mysqli_num_rows($result) > 0): ?>
            <?php while ($row = mysqli_fetch_assoc($result)) : ?>
              ...
              <tr>
                ...
                <td>
                  <button type="button" class="btn btn-info btn-sm text-white fw-semibold shadow-sm"
            ...
            <?php endwhile; ?>
          <?php else: ?>
            <tr><td colspan="6" class="text-muted">Tidak ada data ditemukan.</td></tr>
          <?php endif; ?>
        </tbody>
      </table>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.showDetail = function(id) {
    console.log("Clicked ID:", id); // <--- untuk cek di console
