                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex justify-content-center gap-2">
                      <!-- Tombol Approve -->
                      <form method="POST" action="approval_action.php" class="text-center">
                        <input type="hidden" name="id" value="<?= $row['id_work_order'] ?>">
                        <button type="submit" name="action" value="approve"
                                class="action-btn bg-success-gradient text-white" title="Setujui">
                      ...
                      <form method="POST" action="approval_action.php" class="text-center">
                        ...
                        <button type="submit" name="action" value="reject"
                                class="action-btn bg-danger-gradient text-white" title="Tolak">
